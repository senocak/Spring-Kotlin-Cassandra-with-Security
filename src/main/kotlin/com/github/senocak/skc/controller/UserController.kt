package com.github.senocak.skc.controller

import com.github.senocak.skc.domain.PaginatedResponseTemplate
import com.github.senocak.skc.domain.User
import com.github.senocak.skc.domain.dto.ExceptionDto
import com.github.senocak.skc.domain.dto.UpdateUserDto
import com.github.senocak.skc.domain.dto.UserPaginationDTO
import com.github.senocak.skc.domain.dto.UserResponse
import com.github.senocak.skc.domain.dto.UserWrapperResponse
import com.github.senocak.skc.exception.ServerException
import com.github.senocak.skc.security.Authorize
import com.github.senocak.skc.service.MessageSourceService
import com.github.senocak.skc.service.UserService
import com.github.senocak.skc.util.AppConstants.ADMIN
import com.github.senocak.skc.util.AppConstants.DEFAULT_PAGE_NUMBER
import com.github.senocak.skc.util.AppConstants.DEFAULT_PAGE_SIZE
import com.github.senocak.skc.util.AppConstants.SECURITY_SCHEME_NAME
import com.github.senocak.skc.util.AppConstants.USER
import com.github.senocak.skc.util.OmaErrorMessageType
import com.github.senocak.skc.util.convertEntityToDto
...
class UserController(
    ...
    fun getUserByTemplate(
    ...
    ): PaginatedResponseTemplate<UserResponse> = run {
        ...
        PaginatedResponseTemplate<UserResponse>()
            .also {
                it.page = page
                it.size = size
